...
fun RegistroVent3ScreenContent(
    ...
    val opcionesObjetivoSalud = listOf(
        TarjetaData(
            ...
            descripcion = "Reduce grasa corporal de forma saludable.",
            imagenUrl = "https://drive.google.com/uc?export=view&id=1BS-SBL_ilrVoGXPEZi8MN7lDZeQ5K1mW"
        ),
        TarjetaData(
            titulo = "Mantener Peso",
            descripcion = "Conserva tu peso y estado físico actual.",
            imagenUrl = "https://drive.google.com/uc?export=view&id=1QWORYcrRq4gTAcd1YDtBQU6fdF69myrF"
        ),
        TarjetaData(
            titulo = "Ganancia de Masa Muscular",
            descripcion = "Aumenta músculo con nutrición y entrenamiento.",
        ...
        TarjetaData(
            ...
            descripcion = "Adopta una alimentación balanceada y sostenible a largo plazo.",
    ...
    val alpha by animateFloatAsState(
        targetValue = if (camposValidos) 1f else 0.4f,
        label = "alpha"
    )
    ...
    Column(
        ...
        Box(modifier = Modifier.weight(1f)) {
            ...
            Column(
                ...
                // Título con estilo uniforme al de Vent2
                Text(
                ...
                opcionesObjetivoSalud.forEach { (titulo, descripcion, imagenUrl) ->
                    val isSelected = titulo == seleccionObjetivoSalud
                    ...
                    Card(
                        modifier = Modifier
                            ...
                            .clickable {
                                seleccionObjetivoSalud = titulo
                                viewModel.objetivosSalud = titulo
                            },
                        ...
                        Row(
                            modifier = Modifier
                                .background(
                                    if (isSelected) PastelMint.copy(alpha = 0.25f)
        ...
        // Botón continuar (mismo estilo que Vent2 para uniformidad)
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = MaterialTheme.colorScheme.primary, // 🔹 igual que en Vent2
